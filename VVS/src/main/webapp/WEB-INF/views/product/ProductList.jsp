...
<link
	...
	rel="stylesheet">
<style>
	.orgImg{width:1300px; height:350px;}
</style>
</head>
...
<br><br><br><br>
      ...
      <c:choose>
		...
		<div class="col-lg-14">
            ...
            <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox" style="display:inline-block">
                <c:forEach var="imgList" items="${imgList}">
                   <c:if test="${1 eq imgList.titleImg }">
                  <div class="carousel-item active">                    
                          <img class="orgImg" src="${hContext}/${imgList.img}" alt="First slide">                    
                  </div>
                   </c:if>
                   ...
                   <div class="carousel-item">
                          ...
                          <img class="orgImg" src="${hContext}/${imgList.img}" alt="Second slide">
                  ...
                  <div class="carousel-item">      
                          <img class="orgImg" src="${hContext}/${imgList.img}" alt="Third slide">                          
                  </div>
                  </c:if>
				...
				<div class="col-lg-4 col-md-6 mb-4">								
					<div class="card h-100" style="width:400px">													
						<a href="/shop/product/moveToProductDetail.do?productNum=${list.productNum }"><img class="card-img-top" height="400"
							src="${hContext}/${list.equalImg}" alt=""></a>			
	...
	<script type="text/javascript">
		...
		$("#moveToTitleUpdate").on("click",function(){		
