		...
		<div class="col-sm-6 col-md-offset-3"> 
			<form action="doInsert.do" method="post" role="form" id="registerForm" name="registerForm">
				<div class="form-group"> 
					...
					<input type="text" class="form-control" id="inputId" name="inputId" readonly="readonly" value="${sessionScope.MemberVO.getMemberId()}">
				...
				<div class="form-group"> 
					...
					<input type="text" class="form-control" id="inputName" name="inputName" value="${sessionScope.MemberVO.getName()}"> 
					<div class="eheck_font" id="name_check"></div> 
				</div>
				
				<div class="form-group"> 
					<label for="inputEmail">이메일 주소</label> 
					<input type="email" class="form-control" id="inputEmail" name="inputEmail" value="${sessionScope.MemberVO.getEmail()}"> 
					<div class="eheck_font" id="email_check"></div> 
				</div>
				
				<div class="form-group"> 
					<label for="inputPhone">휴대폰 번호('-'없이 번호만 입력해주세요)</label> 
					<input type="tel" class="form-control" id="inputPhone" name="inputPhone" value="${sessionScope.MemberVO.getPhone()}"> 
				...
				<div>
					<input style="width:300px; background-color:black; margin:5px;" class="btn btn-primary btn-lg" type="button" value="수정하기" id="updateBtn">
